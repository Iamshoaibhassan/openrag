# Portfolio study: openrag

This repository is an attributed fork of [langflow-ai/openrag](https://github.com/langflow-ai/openrag).
...
The upstream repository and its contributors retain authorship of upstream code. This fork preserves upstream license and copyright files. GitHub metadata reports: `Apache-2.0`. Review all nested dependencies and notices before redistribution. This profile does not claim authorship of upstream code.
